...
const Login = () => {
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-center items-center">
      ...
      <img
        className="w-[60%] h-[100vh] object-cover"
        src="https://timess3spore.s3.amazonaws.com/ndata/et_images/webstory/original_image_webp/37bb04ac5e34d6a604b0be5b3c385a99Jamia-Hamdard,-New-Delhi,-Delhi%20(1).jpg"
        alt=""
      />
